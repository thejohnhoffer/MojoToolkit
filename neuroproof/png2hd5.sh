...
python png2hd5.py /data/x/$1/$2/$3/image /data/Red_Cylinder/$1-$2-$3/image.h5 -d 2 -t uint8
...
python png2hd5.py /data/x/$1/$2/$3/gt-mask /data/Red_Cylinder/$1-$2-$3/mask.h5 -d 2 -t uint8
